...
public interface PostMapper {
	...
	@Select("SELECT post.id, title, username, content, username, categoryId, DATE_FORMAT(postedDatetime, \\'%Y-%m-%d\\') AS postedDatetime, DATE_FORMAT(updatedDatetime, \\\\'%Y-%m-%d\\\\') AS updatedDatetime" +
			"FROM post JOIN user ON post.userId=user.id " +
